...
public class BasketMiddleActivity2 extends AppCompatActivity {
...
//                            .putString("RadioPaymentSelected", RadioPaymentSelected)
                    ...
                    ProgressDialog dialog = new ProgressDialog(BasketMiddleActivity2.this);

                    dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                    dialog = ProgressDialog.show(BasketMiddleActivity2.this, "", "لطفا منتظر بمانید...", true);
                    ...
                    setBasket.register(BasketMiddleActivity2.this, dialog, postalEdt.getText().toString(), addressFull, tellEdt.getText().toString(), mobileEdt.getText().toString());
...
//        dialog = ProgressDialog.show(BasketMiddleActivity.this, "", "لطفا منتظر بمانید...", true);
        ...
        maghsad.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                              ...
                                              public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                                  ...
                                                  getShahrPrice.get_price(BasketMiddleActivity2.this, String.valueOf(position + 1), postNahaie,feeNahaie,FeeAll);
//                                                  if (position == 2) {
