...
import ir.shop1.shop1.Activity.HistoryItemBasketActivity;
...
public class getHistoryBasketAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<String> IdItems, DateItems, PriceItems;
    ...
    public getHistoryBasketAdapter(final Context context, List<String> IdItems, List<String> DateItems, List<String> PriceItems, TextView emptyText, RecyclerView recyclerViewlist) {
...
//---------------------------
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            String str1 = changeNumber(formatter.format(Long.valueOf(PriceItems.get(position))) + context.getString(R.string.currency));
            myViewHolder.Price.setText(str1);

            String str2 = "شماره فاکتور: " + changeNumber(formatter.format(Long.valueOf(IdItems.get(position))));
...
//            }
            ...
            myViewHolder.Detail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Intent intent = new Intent(context, HistoryItemBasketActivity.class);
                        intent.putExtra("factor", IdItems.get(position));
            ...
            if (isEven(myViewHolder.getLayoutPosition())) {
                ...
                myViewHolder.cardview.setBackgroundColor(ContextCompat.getColor(context, R.color.light_blue2));
            }
    ...
    private class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView Date, Price, Factor,Detail;
        // View Line;
