...
public class getProductsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private String Direction, Parent, CategoryName, Activity;
    ...
    public getProductsAdapter(final Context context, List<String> ImageItems, List<String> FeeOffItems, List<String> IdItems, List<String> DescriptionItems, List<String> TitleItems, List<String> FeeItems, List<String> IntroItems, List<String> QuantityItems, List<String> LikeItems, List<String> TotalVotesItems, List<String> TotalCommentItems, List<String> ThumbnailItems, List<String> OtherItems, List<String> entesharatItems, List<String> nevisandeItems, List<String> salechapItems, List<String> chapItems, List<String> isbnItems, List<String> virayeshItems, String Direction, String Parent, String Category_name, String Activity, RecyclerView recyclerViewlist) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            if (Direction.equals("Horizontal")) {
                ...
                view = LayoutInflater.from(context).inflate(R.layout.itemview_layout_slim, parent, false);
            }
