...
import ir.shop1.shop1.Activity.ComparisonActivity;
...
public class getSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public getSearchAdapter(final Context context, List<String> ImageItems, List<String> FeeOffItems, List<String> IdItems, List<String> DescriptionItems, List<String> TitleItems, List<String> FeeItems, List<String> IntroItems, List<String> QuantityItems, List<String> LikeItems, List<String> TotalVotesItems, List<String> TotalCommentItems, List<String> OtherItems, List<String> ThumbnailItems, List<String> entesharatItems, List<String> nevisandeItems, List<String> salechapItems, List<String> chapItems, List<String> isbnItems, List<String> virayeshItems,String Intent, String Direction, String Category_name, RecyclerView recyclerViewlist) {
...
//---------------------------
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(context).inflate(R.layout.itemview_layout_slim, parent, false);
