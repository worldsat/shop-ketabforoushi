...
public class getResultAdvencedSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public getResultAdvencedSearchAdapter(final Context context, List<String> ImageItems, List<String> FeeOffItems, List<String> IdItems, List<String> DescriptionItems, List<String> TitleItems, List<String> FeeItems, List<String> IntroItems, List<String> QuantityItems, List<String> LikeItems, List<String> TotalVotesItems, List<String> TotalCommentItems, List<String> ThumbnailItems, List<String> OtherItems, List<String> entesharatItems, List<String> nevisandeItems, List<String> salechapItems, List<String> chapItems, List<String> isbnItems, List<String> virayeshItems,RecyclerView recyclerViewlist) {
...
//---------------------------
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            view = LayoutInflater.from(context).inflate(R.layout.itemview_layout_vertical, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            //   myViewHolder.intro.setText(changeNumber(IntroItems.get(position)));
