...
public class getProductsSpecialAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private List<String> ImageItems, IdItems, DescriptionItems, TitleItems, FeeItems, IntroItems, QuantityItems;
    private List<String> FeeOffItems, LikeItems, TotalVotesItems, TotalCommentItems, ThumbnailItems, ExpireDateItems, OtherItems;
    ...
    public getProductsSpecialAdapter(final Context context, List<String> ImageItems, List<String> FeeOffItems, List<String> IdItems, List<String> DescriptionItems, List<String> TitleItems, List<String> FeeItems, List<String> IntroItems, List<String> QuantityItems, List<String> LikeItems, List<String> TotalVotesItems, List<String> TotalCommentItems, List<String> ThumbnailItems, List<String> ExpireDateItems, List<String> OtherItems, List<String> entesharatItems, List<String> nevisandeItems, List<String> salechapItems, List<String> chapItems, List<String> isbnItems,List<String> virayeshItems, String CurrentDate, RecyclerView recyclerViewlist) {
        ...
        this.ExpireDateItems = ExpireDateItems;
...
//---------------------------
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            String percent = "%" + CalculatePercent(FeeItems.get(position), FeeOffItems.get(position)) + " تخفیف";
            String day_off = "فقط تا " + CalculateTimeDiffrence(CurrentDate, ExpireDateItems.get(position)) + " روز دیگر ";
            ...
            myViewHolder.off.setVisibility(View.VISIBLE);
            myViewHolder.off.setText(percent);
            myViewHolder.day_off.setVisibility(View.VISIBLE);
            myViewHolder.day_off.setText(day_off);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        intent.putExtra("Day_item", CalculateTimeDiffrence(CurrentDate, ExpireDateItems.get(position)));
                        intent.putExtra("Percent_item", CalculatePercent(FeeItems.get(position), FeeOffItems.get(position)));
    ...
    private class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView Title, fee, discount, off, day_off;
        ImageView pic;
        ...
        private MyViewHolder(View itemView) {
            ...
            off = itemView.findViewById(R.id.off_show);
            day_off = itemView.findViewById(R.id.off_day);
    ...
    //calculate ekhtelaf rooz
    private String CalculateTimeDiffrence(String dateStart, String dateStop) {
        ...
        try {
            ...
            d1 = format.parse(dateStart.substring(0, 10));

            d2 = format.parse(dateStop.substring(0, 10));
            ...
            // Log.i("mohsenjamali", "CalculateTimeDiffrence: " + diffDays);
    ...
    //caculate darsad takhfif
    private String CalculatePercent(String Price, String Discount) {

        int price = Integer.valueOf(Price);
        int discount = Integer.valueOf(Discount);
        int fee = price - discount;
        int Percent = (discount * 100) / price;
        // Log.i("mohsenjamali", "CalculatePercent: " + Percent);
