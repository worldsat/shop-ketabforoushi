...
public class getRow1Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public getRow1Adapter(final Context context, List<String> ImageItems, List<String> FeeOffItems, List<String> IdItems, List<String> DescriptionItems, List<String> TitleItems, List<String> FeeItems, List<String> IntroItems, List<String> QuantityItems, List<String> LikeItems, List<String> TotalVotesItems, List<String> TotalCommentItems, List<String> ThumbnailItems, List<String> OtherItems, List<String> entesharatItems, List<String> nevisandeItems, List<String> salechapItems, List<String> chapItems, List<String> isbnItems,List<String> virayeshItems,RecyclerView recyclerViewlist) {
