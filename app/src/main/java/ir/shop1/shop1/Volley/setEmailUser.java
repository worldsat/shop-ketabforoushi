...
public class setEmailUser {
    ...
    public void register(final Context context, final String email) {
        ...
        String urlJsonArray = context.getString(R.string.site) + "/api/Setting/Email";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.equals("{\"Message\":0}")) {
                            Toast.makeText(context, context.getString(R.string.emailOk), Toast.LENGTH_SHORT).show();
                        } else {
