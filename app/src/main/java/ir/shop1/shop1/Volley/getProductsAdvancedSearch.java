...
import ir.shop1.shop1.Adapter.getResultAdvencedSearchAdapter;
import ir.shop1.shop1.OnLoadMoreListener;
import ir.shop1.shop1.R;


public class getProductsAdvancedSearch {

    private getResultAdvencedSearchAdapter ad;
    ...
    public void get_banners(final Context context, final ProgressBar ProgressBar, final RecyclerView recyclerViewlist, final String Category_id, final String name, final String minPrice, final String maxPrice, final String Switch, final TextView nothingTxt) {
        page = 1;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlJsonArray,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                ad = new getResultAdvencedSearchAdapter(context, ImageItems, DiscountItems, IdItems, DescriptionItems, NameItems, PriceItems, TextItems, QuantityItems, LikeItems, TotalVotesItems, TotalCommentItems, ThumbnailItems, OtherItems,entesharatItems, nevisandeItems, salechapItems, chapItems, isbnItems,virayeshItems, recyclerViewlist);
                                ...
                                public void onLoadMore() {
                                    ...
                                    StringRequest MyStringRequest = new StringRequest(Request.Method.POST, urlJsonArray, new Response.Listener<String>() {
                                        ...
                                        protected Map<String, String> getParams() {
                                            ...
                                            MyData.put("minprice", minPrice);
                                            MyData.put("maxprice", maxPrice);
                                            return MyData;
                                        }
                                    };
            ...
            protected Map<String, String> getParams() {
                ...
                MyData.put("minprice", minPrice);
                MyData.put("maxprice", maxPrice);
                Log.i("mohsenjamali", "getParams: "+Switch);
                if (Switch.equals("true")) {
                  //  MyData.put("status", Switch);
                }
                //Log.i("mohsenjamali", "getParamsAdvancedSearch: "+Switch);
                return MyData;
            }
        };
