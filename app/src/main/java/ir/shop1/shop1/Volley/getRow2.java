...
import ir.shop1.shop1.Adapter.getRow2Adapter;
    ...
    public void get_banners(final Context context, final ProgressBar ProgressBar, final RecyclerView recyclerViewlist) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlJsonArray,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            //get name & id
                            String row_id = jsonRootObject.optJSONObject("SecoundCategory").getString("Id");
                            String row_name = jsonRootObject.optJSONObject("SecoundCategory").getString("Name");

                            OneFragment oneFragment=new OneFragment();
                            oneFragment.AllProductRow2(context,row_id,row_name);
                            //end

                            JSONArray array = jsonRootObject.optJSONArray("SecoundProducts");
                            ...
                            try {
                                ...
                                ad = new getRow2Adapter(context, ImageItems, DiscountItems, IdItems, DescriptionItems, NameItems, PriceItems, TextItems, QuantityItems, LikeItems, TotalVotesItems, TotalCommentItems, ThumbnailItems, OtherItems,entesharatItems, nevisandeItems, salechapItems, chapItems, isbnItems,virayeshItems, recyclerViewlist);
                                recyclerViewlist.setAdapter(ad);

                            } catch (Exception e) {
                                Toast.makeText(context, "خطایی پیش آمده است لطفا دوباره امتحان کنید", Toast.LENGTH_SHORT).show();
                                Log.i("mohsenjamali", "onResponseErrorNewest: " + e);
                            }
                        ...
                        /*    ad.setOnLoadMoreListener(new OnLoadMoreListener() {
                            ...
                            Log.i("mohsenjamali", "onErrorResponseNeweset: " + e.getMessage());
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.i("mohsenjamali", "onErrorResponseNeweset: " + error.getMessage());
