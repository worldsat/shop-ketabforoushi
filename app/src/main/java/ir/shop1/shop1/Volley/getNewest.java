...
import ir.shop1.shop1.Adapter.getNewestAdapter;
import ir.shop1.shop1.R;


public class getNewest {

    private getNewestAdapter ad;
    ...
    public void get_banners(final Context context, final ProgressBar ProgressBar, final RecyclerView recyclerViewlist) {
        ...
        final String urlJsonArray = context.getString(R.string.site) +"/api/product/newProduct/getNewest";
                        ...
                        try {
                           ...
                           // pageTotal = jsonRootObject.getInt("TotalItemCount") / 5;
                            ...
                            for (int i = 0; i < array.length(); i++) {
                              ...
                              //  if(!person.getString("Images").equals("null")) {
                            ...
                            try {
                                ...
                                ad = new getNewestAdapter(context, ImageItems, DiscountItems, IdItems, DescriptionItems, NameItems, PriceItems, TextItems, QuantityItems,LikeItems,TotalVotesItems,TotalCommentItems,ThumbnailItems,OtherItems, entesharatItems, nevisandeItems, salechapItems, chapItems, isbnItems,virayeshItems, recyclerViewlist);
