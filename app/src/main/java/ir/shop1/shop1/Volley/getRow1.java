...
import ir.shop1.shop1.Adapter.getRow1Adapter;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            //get name & id
                            String row1_id = jsonRootObject.optJSONObject("FirstCategory").getString("Id");
                            String row1_name = jsonRootObject.optJSONObject("FirstCategory").getString("Name");

                            OneFragment oneFragment=new OneFragment();
                            oneFragment.AllProductRow1(context,row1_id,row1_name);
                            //end

                            JSONArray array = jsonRootObject.optJSONArray("FirstProducts");
                            ...
                            try {
                                ...
                                ad = new getRow1Adapter(context, ImageItems, DiscountItems, IdItems, DescriptionItems, NameItems, PriceItems, TextItems, QuantityItems, LikeItems, TotalVotesItems, TotalCommentItems, ThumbnailItems, OtherItems,entesharatItems, nevisandeItems, salechapItems, chapItems, isbnItems,virayeshItems, recyclerViewlist);
